<template>
  <div class="container">
    <div style="width: 380px; padding: 30px; background-color: rgba(255, 255, 255, .6); border-radius: 5px;">
      <div style="text-align: center; font-size: 24px; margin-bottom: 30px; color: #333">欢迎注册灾情救援系统</div>
      <el-form ref="formRef" :model="form" :rules="rules">
        ...
        <el-form-item>
          <el-button size="medium" style="width: 100%;" type="primary" @click="register">注 册</el-button>
        </el-form-item>
