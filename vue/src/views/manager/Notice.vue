  ...
  <div>
    ...
    <div class="table">
      <el-table :data="tableData" stripe @selection-change="handleSelectionChange">
        ...
        <el-table-column align="center" label="序号" prop="id" sortable width="80"></el-table-column>
    ...
    <el-dialog :close-on-click-modal="false" :visible.sync="fromVisible" destroy-on-close title="信息" width="40%">
