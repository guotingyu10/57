<template>
  <div>
    <div class="search">
      <el-input placeholder="请输入内容关键字查询" style="inline-size: 200px" v-model="content"></el-input>
      <el-button type="info" plain style="margin-inline-start: 10px" @click="load(1)">查询</el-button>
      <el-button type="warning" plain style="margin-inline-start: 10px" @click="reset">重置</el-button>
    </div>
